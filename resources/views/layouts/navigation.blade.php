        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="/techersdata">Teachers</a></li>          
              <li class="nav-item"> <a class="nav-link" href="/clarkdata">Clark</a></li>
              <li class="nav-item"> <a class="nav-link" href="/accountantdata">Accountant</a></li>
              <li class="nav-item"> <a class="nav-link" href="/employeedata">Employees</a></li>
            </ul>
          </div>
        </li>
