        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Clark</li>
                </ol>
              </nav>
                ...
                <div class="col-md-6 offset-3">
                    <div wire:ignore.self class="modal fade" id="form" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add Clark</h5>
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                                            <label for="clark-name" class="col-form-label">Name:</label>
                                            <input type="text" wire:model="Clark_name" class="form-control"
                                                id="recipient-name">
                                        </div>
                                        <div class="form-group">
                                            <label for="clark-number" class="col-form-label">Number:</label>
                                            <input type="text" wire:model="Clark_number" class="form-control"
                                                id="recipient-number">
                                        </div>
                                        <div class="form-group">
                                            <label for="teacher-number" class="col-form-label">Email:</label>
                                            <input type="email" wire:model='Clark_email' class="form-control"
                                                id="recipient-email">
                                        </div>
                                        <div class="form-group">
                                            <label for="clark-address"
                                                class="col-form-label">Address:</label>
                                            <input type="text" wire:model='Clark_address' class="form-control"
                ...
                <div class="col-md-6 offset-3">
                    <div wire:ignore.self class="modal fade" id="modelUpdate" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modelUpdate">Edit Clark</h5>
